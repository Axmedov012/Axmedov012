    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="m-3" method="POST" action="{{ route('projects.store') }}">
                    @csrf
                    <!-- title -->
                    <div>
                        <x-input-label for="" :value="__('Title')" />
                        <x-text-input id="" class="block mt-1 w-full" type="text" name="title" required autofocus autocomplete="title" />
                        <x-input-error :messages="$errors->get('title')" class="mt-2" />
                    </div>
                    <!-- Description -->
                    <div>
                        <x-input-label for="description" :value="__('Description')" />
                        <x-text-input id="" class="block mt-1 w-full" type="text" name="description" required autofocus autocomplete="description" />
                    ...
                    <div>
                        ...
                        <x-text-input id="" class="block mt-1 w-full" type="date" name="deadline_at" required autofocus autocomplete="deadline_at" />
